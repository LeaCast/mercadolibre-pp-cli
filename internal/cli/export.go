...
large datasets as it has no memory pressure.`,
  ...
  mercadolibre-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  mercadolibre-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  mercadolibre-pp-cli export <resource> --format jsonl | jq '.id'`,
