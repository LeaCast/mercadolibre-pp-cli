...
but do not stop the import.`,
  ...
  mercadolibre-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  mercadolibre-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | mercadolibre-pp-cli import <resource> --input -`,
