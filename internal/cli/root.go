...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "mercadolibre-pp-cli",
		Short: "Manage mercadolibre resources via the mercadolibre API",
		Long: `Manage mercadolibre resources via the mercadolibre API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'mercadolibre-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("mercadolibre-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'mercadolibre-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSitesPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("mercadolibre-pp-cli %s\n", version)
		},
	}
}
